...
{
    public partial class natlan : Form
    {
        public natlan()
        {
            InitializeComponent();
        ...
        private void natlan_Load(object sender, EventArgs e)
        {
            
            
            foreach(string item in CreateCommand("Select enemyname from enemy where kingdomid=6", @"Data Source=KZ2-RM05\SQLEXPRESS;Initial Catalog=g1;Integrated Security=True"))
            {
