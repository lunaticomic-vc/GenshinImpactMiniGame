...
{
    public partial class inazuma : Form
    {
        public inazuma()
        {
            InitializeComponent();
        ...
        private void inazuma_Load(object sender, EventArgs e)
        {
            
            
            foreach(string item in CreateCommand("Select enemyname from enemy where kingdomid=3", @"Data Source=KZ2-RM05\SQLEXPRESS;Initial Catalog=g1;Integrated Security=True"))
            {
