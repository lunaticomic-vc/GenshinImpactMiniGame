...
{
    public partial class sumeru : Form
    {
        public sumeru()
        {
            InitializeComponent();
        ...
        private void sumeru_Load(object sender, EventArgs e)
        {
            foreach(string item in CreateCommand("Select enemyname from enemy where kingdomid=4", @"Data Source=KZ2-RM05\SQLEXPRESS;Initial Catalog=g1;Integrated Security=True"))
            {
        ...
        private void fillByToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.enemyTableAdapter1.FillBy(this.g1DataSet4.Enemy);
            }
        ...
        private void fillByToolStripButton1_Click(object sender, EventArgs e)
        {
            try
            {
                this.enemyTableAdapter.FillBy(this.g1DataSet3.Enemy);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        private void fillByToolStripButton_Click_1(object sender, EventArgs e)
        {
            try
            {
                this.enemyTableAdapter2.FillBy(this.g1DataSet5.Enemy);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
