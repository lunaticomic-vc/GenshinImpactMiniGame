...
{
    public partial class snezhnaya : Form
    {
        public snezhnaya()
        {
            InitializeComponent();
        ...
        private void snezhnaya_Load(object sender, EventArgs e)
        {
            
            foreach(string item in CreateCommand("Select enemyname from enemy where kingdomid=5", @"Data Source=KZ2-RM05\SQLEXPRESS;Initial Catalog=g1;Integrated Security=True"))
            {
