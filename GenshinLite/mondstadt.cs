...
{
    public partial class mondstadt : Form
    {
        public mondstadt()
        {
            InitializeComponent();
        ...
        private void mondstadt_Load(object sender, EventArgs e)
        {
            
            
            foreach(string item in CreateCommand("Select enemyname from enemy where kingdomid=1", @"Data Source=KZ2-RM05\SQLEXPRESS;Initial Catalog=g1;Integrated Security=True"))
            {
