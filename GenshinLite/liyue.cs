...
{
    public partial class liyue : Form
    {
        public liyue()
        {
            InitializeComponent();
        ...
        private void liyue_Load(object sender, EventArgs e)
        {
            
            foreach(string item in CreateCommand("Select enemyname from enemy where kingdomid=2", @"Data Source=KZ2-RM05\SQLEXPRESS;Initial Catalog=g1;Integrated Security=True"))
            {
